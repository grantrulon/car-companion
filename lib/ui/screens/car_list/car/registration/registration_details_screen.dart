...
class RegistrationDetailsScreen extends ConsumerStatefulWidget {
  ...
  RegistrationDetailsScreenState createState() =>
      RegistrationDetailsScreenState();
}

class RegistrationDetailsScreenState
  ...
  Widget build(BuildContext context) {
    ...
    if (currentCar case AsyncData(:final value)) {
      ...
      plateController.text = value.registration!.plate;
      stateController.text = value.registration!.state;
      if (newExpirationDate == null) {
        expirationDateController.text =
            DateFormat().add_yMd().format(value.registration!.expirationDate);
      }
    }
          ...
          child: Scaffold(
            ...
            body: Container(
              ...
              child: ListView(children: <Widget>[
                ...
                for (var dataEntry in value.registration!.moreData.entries)
                  Padding(
                    ...
                    child: ListTile(
                      leading: _readOnly
                          ...
                          : IconButton(
                              onPressed: () {
                                var newMoreData = value.registration!.moreData;
